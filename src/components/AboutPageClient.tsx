...
import { ArrowLeft, Monitor, Bot, Cpu, MoveRight, Layers, Sparkles, Smartphone } from "lucide-react";
...
export default function AboutPageClient() {
    ...
    return (
        <main className="min-h-screen relative flex flex-col items-center justify-start overflow-x-hidden">
            {/* Background elements */}
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#c6f023]/10 blur-[120px] rounded-full pointer-events-none -z-10 animate-pulse" />
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#c6f023]/5 blur-[120px] rounded-full pointer-events-none -z-10" />
            ...
            <div className="max-w-6xl w-full mx-auto px-6 pt-32 pb-16 z-10 flex flex-col gap-12">
                ...
                >
                    <Link
                        href="/"
                        className="inline-flex items-center gap-2 text-zinc-500 hover:text-zinc-950 dark:text-zinc-400 dark:hover:text-white text-xs font-bold uppercase tracking-wider transition-colors duration-200 group"
                    >
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="lg:col-span-2 bg-white dark:bg-zinc-900/40 border border-zinc-200/80 dark:border-zinc-800/80 p-6 sm:p-8 rounded-3xl shadow-sm flex flex-col justify-between hover:border-zinc-300 dark:hover:border-zinc-700 hover:shadow-md transition-all duration-300 group"
                    >
                        <div>
                            <h3 className="text-2xl sm:text-3xl lg:text-[38px] font-black tracking-tight leading-[1.15] text-zinc-950 dark:text-white mb-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-zinc-500 dark:text-zinc-400 font-medium text-sm sm:text-base leading-relaxed">
                                <p>
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="bg-white dark:bg-zinc-900/40 border border-zinc-200/80 dark:border-zinc-800/80 p-6 rounded-3xl shadow-sm flex flex-col justify-between hover:border-zinc-300 dark:hover:border-zinc-700 hover:shadow-md transition-all duration-300"
                    >
                        <div className="flex flex-col gap-2 mb-4">
                            <span className="text-xs font-bold uppercase tracking-wider text-zinc-500">Interactive Map</span>
                            <h3 className="font-extrabold text-xl lg:text-2xl tracking-tight text-zinc-900 dark:text-white flex items-center gap-1.5">
                ...
                <div className="w-full mt-6" role="region" aria-label="Professional timeline journey">
                    <motion.div
                        initial={{ opacity: 0, y: 15 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.6, ease: "easeOut" }}
                        className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-2 mb-6"
                    >
                        <div className="flex items-center gap-2">
                            <h2 className="text-zinc-900 dark:text-white font-extrabold text-xl sm:text-3xl tracking-tight uppercase">Professional Journey</h2>
                        </div>
                    ...
                    {/* Draggable Timeline */}
                    <div className="relative w-full overflow-hidden select-none bg-white dark:bg-zinc-900/20 border border-zinc-200/60 dark:border-zinc-800/60 rounded-3xl p-6 sm:p-8 shadow-sm">
                        <div
                            ref={scrollRef}
                        ...
                        >
                            <div className="flex flex-row pr-24 pl-4 min-w-full">
                                {timelineData.map((item, idx) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            {/* Ruler Ticks */}
                                            <div className="flex justify-between items-start h-8 w-full border-t border-zinc-200 dark:border-zinc-800 pt-0 pr-[3px] select-none pointer-events-none">
